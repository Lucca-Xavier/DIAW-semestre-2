...
public class Service {
    ...
    public String consultarModelos(int id) {
        // return
        // consultarURL("https://parallelum.com.br/fipe/api/v1/carros/marcas/"+id+"/modelos");
        return consultarURL(BASE_URL + "/cars/brands/" + id + "/models");
    }

    public String consultarAnos(int marca, int modelo) {
        // return
        // consultarURL("https://parallelum.com.br/fipe/api/v1/carros/marcas/"+marca+"/modelos/"+modelo+"/anos");
    ...
    public String consultarValor(int marca, int modelo, String ano) {
        // return
        // consultarURL("https://parallelum.com.br/fipe/api/v1/carros/marcas/"+marca+"/modelos/"+modelo+"/anos/"+ano);
